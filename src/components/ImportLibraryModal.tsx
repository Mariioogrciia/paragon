  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="flex items-center gap-1.5 rounded-[9px] border border-border px-3.5 py-2 text-[0.8125rem] font-semibold text-muted transition-all hover:-translate-y-0.5 hover:bg-surface-2 hover:text-foreground"
      >

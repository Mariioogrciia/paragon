...
export function TrophyRecommendations({ recommendations, handle }: { recommendations: TrophyRecommendation[]; handle: string }) {
  ...
  // que ya usa la ficha de cada juego (TrophyGuideModal), en vez de mandar a
  // buscarlo aparte cuando ya se está mirando aquí mismo qué toca ahora.
    ...
    <section className="rounded-[18px] border border-border bg-surface p-5">
      <div className="mb-4 flex flex-wrap items-end justify-between gap-2">
        <div>
          ...
          <p className="mt-1 text-sm text-muted">Prioridad automática: progreso alto y mayor probabilidad de conseguirlo.</p>
        </div>
